...
transformed parameters {
  ...
  lprior += student_t_lpdf(Intercept | 3, 45.1, 35);
  lprior += exponential_lpdf(sigma | 1);
  lprior += cauchy_lpdf(sd_1 | 0, 2) - 8 * cauchy_lccdf(0 | 0, 2);
  lprior += lkj_corr_cholesky_lpdf(L_1 | 1);
  lprior += cauchy_lpdf(sd_2 | 0, 2) - 8 * cauchy_lccdf(0 | 0, 2);
  ...
  if (!prior_only) {
    ...
    for (n in 1 : N) {
      ...
      mu[n] += r_1_1[J_1[n]] * Z_1_1[n] + r_1_2[J_1[n]] * Z_1_2[n]
               ...
               + r_1_7[J_1[n]] * Z_1_7[n] + r_1_8[J_1[n]] * Z_1_8[n]
