...
# run chains
chn_ger = sample(model_ger, NUTS(1_000, 0.8), MCMCThreads(), 1_000, 4)
chn_fg = sample(model_fg, NUTS(1_000, 0.8), MCMCThreads(), 1_000, 4)
chn_ce = sample(model_ce, NUTS(1_000, 0.8), MCMCThreads(), 1_000, 4)
chn_pca = sample(model_pca, NUTS(1_000, 0.8), MCMCThreads(), 1_000, 4)
